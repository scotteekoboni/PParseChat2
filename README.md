...
**PParseChat2** is a Chat app using an [open source Parse](http://parseplatform.org/) backend.
...
the Serve broke and i couldnt even run my app. ill finish it eventually, but im still trying to understand serves and parse as a whole
